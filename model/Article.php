...
class Articles {
    ...
    public function __construct($id_article,$titre_article,$date_article,$contenu_article,$nbr_article,$id_utilisateur,$id_categorie,$nbr_like) {
    ...
    public function afficher() {
        ...
        echo "Nombre article :  ".$this->nbr_article."<br>";
